...
const float z1 = 0.414;
const float z2 = 0.062;
...
//-I heard: [-0.354083,0.693537,0.156041,0.607686,0.158831,0.740143,-0.165744]]
	...
	homepose.orientation.x=0.137257;
	homepose.orientation.y=0.509602;
	homepose.orientation.z=-0.003544;
	homepose.orientation.w=0.849384;
   homepose.position.x = 0.360366;
   homepose.position.y = 0.299682;
   homepose.position.z = -0.114068;
 ...
 void robo_arm(int number  = 10)
  {
	...
	if (thingposeflag)
	{
		thingpose.position.z+=0.05;
		waypoints.push_back(thingpose);
		thingpose.position.x += 0.25*xr;
 		thingpose.position.y += 0.25*yr;
...
void movetopose( const geometry_msgs::Pose& pose)
	{
		...
		thingpose.position.x += 0.07*xr;
 		thingpose.position.y += 0.07*yr;
		if(thingpose.position.z> 0.15) thingpose.position.z= z1;
		else thingpose.position.z= z2;
		homepose.position.z = thingpose.position.z;
		midp.position.z = thingpose.position.z;
