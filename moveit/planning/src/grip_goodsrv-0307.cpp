...
std::vector<geometry_msgs::Pose> waypoints;
  ...
  //by zhang yu mei 20160120, other conditions , go to pose1, the old place
   ...
   thingpose.position.z =POINTS[number][2]+0.02;
...
//transform the contour widths to the angle of servo
//the motion of hand is control servo4
  /*void shortExtentCallback(const std_msgs::UInt16& msg)
   {
 	//extern int angle2;
	angle2 = (int)(-1.2842*msg.data+68.119+5);
        //angle1 = 5;   
	//ROS_INFO("After calculate,the angle is %d ",angle2); 
   }*/
...
int main(int argc, char **argv)
{
  ...
  ros::NodeHandle n;
  //ros::Subscriber servo_angle = n.subscribe("/short_extent",1,shortExtentCallback);//width of contour
  GRIPCV grip;
