...
float T_data[4][4] = {		0.235641037286248	,0.762679305320788,	0.611133264224981,	-620.038687453729,
		0.962871668763073	,-0.123557539458269,	-0.217306329357677	,604.105483032636,
		0.0717078666194136,	-0.603939732557212,	0.793634854211269,	-2239.76051470406,
		0	,0	,0	,1};
...
bool ConverKinectToWorld(cv::Point3f &PtInKinect, cv::Mat &T4x4_32F)
{
	...
	srvpose.position.x = -m_pt_w.ptr<float>(1)[0]; 
	srvpose.position.y = -m_pt_w.ptr<float>(0)[0];
